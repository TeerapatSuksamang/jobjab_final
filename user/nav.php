    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="hamburger">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a href="status.php" class="nav-link <?php echo ($page == 'status' ? 'active' : '') ?>">สถานะคำสั่งซื้อ</a>
                </li>
                <li class="nav-item">
                    <a href="history.php" class="nav-link <?php echo ($page == 'history' ? 'active' : '') ?>">ประวัติการสั่งซื้อ</a>
                </li>
            </ul>
            <hr class="text-light">
